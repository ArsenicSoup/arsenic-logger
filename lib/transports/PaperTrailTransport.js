...
var PaperTrailTransport = {
    ...
    */
    ...
    __getText : function(args, level, stackObj, hasTag, settings, filterOptions){
        ...
        var col = "";
        var reset = PaperTrailTransport.colors.reset;

        switch(level){
            case 'log': col = PaperTrailTransport.colors.green; log_level = 0; break;
            case 'debug': col = PaperTrailTransport.colors.green; log_level = 1; break;
            case 'info': col = PaperTrailTransport.colors.blue; log_level = 2; break;
            case 'warn': col = PaperTrailTransport.colors.magenta; log_level = 3; break;
            case 'error': col = PaperTrailTransport.colors.lightRed; log_level = 4; break;
            case 'fatal': col = PaperTrailTransport.colors.red; log_level = 5; break;
            case 'exception': col = PaperTrailTransport.colors.whiteOnRed; log_level = 5; break;
        }

        var trace_str = PaperTrailTransport.colors.gray;
        var depth = 1;
        var startDepth = 3;
        ...
        var tagStr = "";
        if (matchedTags != ""){
            //tagStr = PaperTrailTransport.colors.tag + " " + tag + " " + reset + " ";
            tagStr = '[' + matchedTags + '] ';
        }
